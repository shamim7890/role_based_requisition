            ...
            <div className="max-w-5xl mx-auto p-6">
                <div className="bg-gray-800 rounded-lg shadow-2xl border border-gray-700">
                    <div className="bg-gradient-to-r from-purple-600 to-purple-800 p-6 rounded-t-lg">
                        <h1 className="text-3xl font-bold text-white">New Admin Item Requisition</h1>
                        <p className="text-purple-100 mt-2">Request admin items from inventory</p>
                    </div>
